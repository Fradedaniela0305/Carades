      ...
      <div className={`relative w-full max-w-[480px] ${colors.bg} border-2 ${colors.border} rounded-2xl shadow-xl overflow-hidden transition-all duration-300`}>
        ...
        <div className="p-10 pb-0">
          <div className="flex justify-between items-center mb-8">
            ...
            <button onClick={onClose} className={`absolute top-5 right-7 font-goldman text-sm ${isDarkMode ? 'text-[#7BFF6C]/60 hover:text-[#7BFF6C]' : 'text-slate-400 hover:text-red-500'} transition-colors`}>
              [ ESC ]
            </button>
          </div>
          ...
          <div className="mt-12 mb-10 flex justify-center">
            <button onClick={onClose} className={`group relative px-12 py-4 text-black font-goldman font-extrabold uppercase tracking-[0.2em] hover:scale-105 transition-all active:scale-95 ${isDarkMode ? "bg-[#7BFF6C] hover:bg-[#5cdb4f]" : "bg-[#39A132] text-white hover:bg-slate-900"}`}>
              CONFIRM
